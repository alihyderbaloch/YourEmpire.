        ...
        if action == 'add':
            ...
            if method_id:
                ...
                if method:
                    ...
                    payments_using_method = Payment.query.filter_by(payment_method_id=int(method_id)).first()
                    if payments_using_method:
                        flash('Cannot delete this payment method - it is being used by existing payments!', 'error')
                    else:
